    ...
    >
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-white/10">
          <div>
            ...
            <p className="max-w-[410px] mt-6 text-sm leading-relaxed">
              FICIALI LTD is a private limited company registered in England and
              Wales (Company No. 15382720). Registered office: England and
              Wales. Incorporated under the Companies Act 2006 on 2nd January
              2024.
            </p>
          </div>
        ...
        <p className="py-4 text-center text-sm text-gray-400">
          © {new Date().getFullYear()} Ficiali . All rights reserved.
        </p>
      </div>
    </motion.footer>
  );
